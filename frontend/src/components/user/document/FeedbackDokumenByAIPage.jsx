...
const FeedbackDokumenByAIPage = () => {
  ...
  // full process from getting the pdf -> to get feedback from openai
  ...
  const generateFeedback = async (text) => {
    try {
      ...
      console.log("Feedback received:", { hasilAnalisa, halYangBisaDirevisi, catatanTambahan });
      ...
      // update the "dokumen" entity in firestore based on the text generated by AI
